...
namespace DataStructures.Tree.BinaryTree
{
        ...
        where T : IComparable
    {
        ...
        public List<Node<T>> PreOrderNonRecursiveTraversal(Node<T> root)
        {
            ...
            if (root == null)
                throw new Exception("Three is empty!");
        ...
        public static int NumberOfFullNodes(Node<T> root) => new BinaryTree<T>().LevelOrderNonRecursiveTraversal(root)
        ...
        private void PrintPaths(Node<T> root, T[] path, int pathLen)
        {
            ...
            if (root.Left == null && root.Right == null) // yaprak
