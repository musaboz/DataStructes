...
namespace DataStructures.Heap
{
        ...
        where T : IComparable
    {
        ...
        public BinaryHeap(SortDirection sortDirection = SortDirection.Ascending) : this(sortDirection, null, null)
        {
        ...
        {
            // Silme işlemi için, belirlenen kök değeri sıralamayı bozduğu için aşağı inmesi gerektiğinde ortaya çıkar.
            int index = 0;
