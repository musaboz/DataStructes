...
namespace DataStructures.Graph.AdjacencySet
{
    ...
    {
        // İlki tip, ikincisi ise ağırlık için ifade edilir.
            ...
            where TW : IComparable
        {
            ...
            public IEnumerator<T> GetEnumerator()
            {
                ...
                // Burada x.Key dediğimizde Dictionary içerisindeki WeightedGraphVertex değerine ulaşırız ama biz onun içerisindeki anahtar değerine erişmeye çalıştığımız için bir tane daha Key değeri koyarız.
            }
